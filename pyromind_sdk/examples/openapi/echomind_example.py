#!/usr/bin/env python3
"""
EchoMind Instance Management Example

This example demonstrates how to create, manage, and interact with EchoMind instances.
...
def create_echomind_example():
    """Example: Create a new EchoMind instance"""
...
def list_echomind_example():
    """Example: List all EchoMind instances"""
    # API key is read from PYROMIND_API_KEY environment variable
    client = PyroMindAPIClient()
...
def get_echomind_example(job_id: str):
    """Example: Get a specific EchoMind instance"""
    # API key is read from PYROMIND_API_KEY environment variable
    client = PyroMindAPIClient()
...
def update_echomind_example(job_id: str):
    """Example: Update an EchoMind instance configuration"""
    # API key is read from PYROMIND_API_KEY environment variable
    client = PyroMindAPIClient()
    
    try:
        print(f"Updating EchoMind instance {job_id}...")
        job = client.echomind.update(
            job_id=job_id,
...
def pause_echomind_example(job_id: str):
    """Example: Pause an EchoMind instance"""
    # API key is read from PYROMIND_API_KEY environment variable
    client = PyroMindAPIClient()
    
    try:
        print(f"Pausing EchoMind instance {job_id}...")
        job = client.echomind.pause(job_id)
...
def resume_echomind_example(job_id: str):
    """Example: Resume a paused EchoMind instance"""
    # API key is read from PYROMIND_API_KEY environment variable
    client = PyroMindAPIClient()
    
    try:
        print(f"Resuming EchoMind instance {job_id}...")
        job = client.echomind.resume(job_id)
...
def delete_echomind_example(job_id: str):
    """Example: Delete an EchoMind instance"""
    # API key is read from PYROMIND_API_KEY environment variable
    client = PyroMindAPIClient()
...
def main():
    ...
    print("=" * 60)
    print("EchoMind Instance Management Examples")
    print("=" * 60)
    
    # List existing instances
    jobs = list_echomind_example()
